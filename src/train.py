...
if __name__ == '__main__':
    ...
    parser.add_argument("-encoder", default='roberta', type=str, choices=['bert', 'baseline','roberta'])
    parser.add_argument("-mode", default='train', type=str, choices=['train', 'validate', 'test'])
    parser.add_argument("-bert_data_path", default='/storage/longjing/run/dimsum/DimSum/roberta-data/cnndm/cnndm.')
    ...
    parser.add_argument("-ext_layers", default=12, type=int)
    # 设置dim_layers
    parser.add_argument("-dim_layers", default=1, type=int)
    parser.add_argument("-ext_hidden_size", default=1024, type=int)
    parser.add_argument("-ext_heads", default=12, type=int)
    ...
    parser.add_argument("-test_from", default="../models/cnndm_final/model_step_30000.pt")
